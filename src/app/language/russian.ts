export const ru = {
    ...
    Back: 'Назад',
    Would_You_Like_To_Hire_This_Shout: 'Вы хотите нанять этого барда:',
    You_Cannot_Afford_To_Hire_This_Shout: 'Вы не можете позволить себе нанять этого барда:',
    ...
    Shout_Hire_Cost_Positive: '+${value}% Стоимость найма барда',
    Shout_Hire_Cost_Negative: '-${value}% Стоимость найма барда',
    Thruum_GP_Positive: '+${value}% GP музыки',
    Thruum_GP_Negative: '-${value}% GP музыки',
    Shout_Hire_Limit_Positive: '+${value} Лимит найма барда',
    Shout_Hire_Limit_Negative: '-${value} Лимит найма барда',
    ...
    Teacher_Maraca: 'Маракас',
    Teacher_Xylophone: 'Ксилофон',
    Teacher_Saxophone: 'Саксофон',
    Teacher_Violin: 'Скрипка',
    Teacher_Bongo: 'Бонго',
    ...
    Thruum: 'Музыка',
    Settings_Shout_Hire_Cost: 'Стоимость найма барда',
    ...
    Settings_Base_Shout_Hire_Cost_1: 'Базовая стоимость найма барда с разблокированным 1 модификатором',
    Settings_Base_Shout_Hire_Cost_2: 'Базовая стоимость найма барда с разблокированными 2 модификаторами',
    Settings_Base_Shout_Hire_Cost_3: 'Базовая стоимость найма барда с разблокированными 3 модификаторами',
    Settings_Base_Shout_Hire_Cost_4: 'Базовая стоимость найма барда с разблокированными 4 модификаторами',
