export const it = {
    ...
    Back: 'Indietro',
    Would_You_Like_To_Hire_This_Shout: 'Desideri assumere questo barista:',
    You_Cannot_Afford_To_Hire_This_Shout: 'Non puoi permetterti di assumere questo barista:',
    ...
    Shout_Hire_Cost_Positive: '+${value}% Costo Assunzione Shout',
    Shout_Hire_Cost_Negative: '-${value}% Costo Assunzione Shout',
    Thruum_GP_Positive: '+${value}% GP Thruuma',
    Thruum_GP_Negative: '-${value}% GP Thruuma',
    Shout_Hire_Limit_Positive: '+${value} Limite Assunzione Shout',
    Shout_Hire_Limit_Negative: '-${value} Limite Assunzione Shout',
    ...
    Teacher_Xylophone: 'Xilofono',
    Teacher_Saxophone: 'Sassofono',
    ...
    Thruum: 'Thruuma',
    Settings_Shout_Hire_Cost: 'Costo Assunzione Shouto',
    ...
    Settings_Base_Shout_Hire_Cost_1: 'Costo di assunzione di base del shouto con 1 modificatore sbloccato',
    Settings_Base_Shout_Hire_Cost_2: 'Costo di assunzione di base del shouto con 2 modificatori sbloccati',
    Settings_Base_Shout_Hire_Cost_3: 'Costo di assunzione di base del shouto con 3 modificatori sbloccati',
    Settings_Base_Shout_Hire_Cost_4: 'Costo di assunzione di base del shouto con 4 modificatori sbloccati',
