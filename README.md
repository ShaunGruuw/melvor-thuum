...
Thruum is a brand new skill which combines themes from Astrology, Thieving and Agility. It provides an easy way to obtain gold and powerful bonuses that benefit other skills.
...
* Level 40 Mastery Unlock - 100,000 GP + 1 Essence of Thruum
* Level 75 Mastery Unlock - 1,000,000 GP + 1 Essence of Thruum
* Level 99 Mastery Unlock - 10,000,000 GP + 1 Essence of Thruum
...
### Sheet Thruum, Essence of Thruum, Gems and Utilities

Training Thruum has a 2% chance to drop sheet thruum, these are used for mastered shout teacher upgrades.

Sheet Thruum drop chance is a flat 2% and is not modified by any rarity increases, the only other boost to sheet thruum drop chance is applying Diamond String to your mastered shouts teacher. With two shouts, this means you can get a total of 12% drop chance for Sheet Thruum.
...
Upgrading a mastered shouts teacher unlocks a 5th modifier, to do so, you require an Essence of Thruum.

Essence of Thruum
Upgrade from Sheet Thruum
1,000,000GP + 50 Sheet Thruum
...
Polished Topaz Gem
Upgrade from Topaz
50,000 GP + 50 Topaz + 10 Sheet Thruum
+5% Thruum GP

Polished Ruby Gem
Upgrade from Ruby
50,000 GP + 50 Ruby + 10 Sheet Thruum
+5% Thruum Skill XP

Polished Sapphire Gem
Upgrade from Sapphire
50,000 GP + 50 Sapphire + 10 Sheet Thruum
+5% Thruum Mastery XP
...
50,000 GP + 100 Diamond + 100 Bowstring + 50 Thruum Sheet
+5% Sheet Thruum drop chance

Pristine Leather
Upgrade from Leather
50,000 GP + 100 Diamond + 100 Leather + 50 Thruum Sheet
-5% Thruum Interval

Mystic Oil
Upgrade from Weird Gloop
50,000 GP + 100 Diamond + 100 Weird Gloop + 50 Thruum Sheet
+1 additional reward roll while training Thruum

Mystic Oil will roll for rewards an additional time when training the thruum skill.
...
1 tick of training Thruum will roll 3 times for a chance to get the pet, rare drops, summoning marks and mastery tokens.

![Apply](images/apply.png)

## Band Practice

The shop sells an upgrade which unlocks a second shout slot. This upgrade requires Level 110 Thruum and costs 1B GP.
...
Leveling the Thruum skill unlocks additional thruumal teachers to train your shouts with.

![Skill Unlocks](images/teacher-unlocks.png)

## Mastery Pool Unlocks

Mastery Pool checkpoints provide additional xp, mastery xp, thruum interval and Master cost reduction.
...
The Thruum Skill Cape

![Thruum Skillcape](images/thruum-skillcape.png)

The Superior Thruum Skill Cape

![Superior Thruum Skillcape](images/superior-thruum-skillcape.png)
...
* Tier 1: +10% Thruum GP, 15 Charges
* Tier 2: +20% Thruum GP, 25 Charges
* Tier 3: +30% Thruum GP, 35 Charges
* Tier 4: +50% Thruum GP, 50 Charges
...
The Thruum skill has its own tablet. The Shout! The Shout is both a combat and skill tablet.
...
* Skill Bonus: +5% Thruum GP

In addition, the Shout has synergies with every single other tablet. Since Thruum is a skill that focuses on boosting other skills, its synergy helps all other skills. It basically doubles the tablet effect of the tablet it is synergizing with (by granting the same tablet modifiers via the synergy).
...
Agility has been modified so that the Obstacle 10 - Waterfall now also benefits the Thruum skill.

![Agility](images/agility.png)

## Astrology

Astrology has been modified so that the Variel constellation now also benefits the Thruum skill.

![Astrology](images/astrology.png)

## Township

The Thruum skill adds a Thruum Scroll of XP granting +3% Thruum Skill XP. It functions the same as other scrolls of xp.

It requires level 15 Township and level 15 Thruum to purchase, with a default value of 80 planks per scroll.

![Township](images/township-xp-scroll.png)

The Thruum skill adds a Thruum Outfit, which is fully integrated just like all the other skilling outfits.
...
The Jester can drop a Guitar which is a new 2H Weapon which requires attack and thruum levels to equip. The Guitar can be upgraded twice.
...
Thruum has Ancient Relics

#1: +50% Thruum Mastery XP
#2: +10% chance to obtain Shrimp while training Thruum
...
Thruum also has a Lesser Relic which grants:
...
# 1.13.13
* fixed superior max cape and superior cape of completion not inheriting thruum skillcape modifiers
...
* thruum skill level cap in the ancient relics gamemode now scales with combat stats level cap
* thruum is no longer offered as a choice for skill cap level increases
* improved logic for unlocking thruum skill to support custom ancient relic gamemodes

# 1.13.4
* added a new teacher, the flute which focuses on cartography and archaeology

# 1.13.3
* added ancient relics for thruum
* added a lesser relic for thruum

# 1.13.2
* fixed thruum being locked in ancient relics gamemode on existing saves when enabling the mod for the first time
...
# 1.13.1
* fixed thruum being locked in ancient relics gamemode
...
* unlocking modifiers now also cost gp in addition to essence of thruum, costs are 100k for level 40 modifier, 1m for level 75 modifier and 10m for level 99 modifier
...
* max skillcape and superior max skillcape no longer require the thruum skill to purchase
* eagle + shout synergy now grants -10% Thruum Interval, from -5% Agility Interval
* owl + shout synergy now grants +1.5% Thruum Mastery XP Per Maxed Star in Variel, from -5% Astrology Interval
...
* mystic oil no longer grants +1 modifier unlock, now rolls an additional time for rewards while training thruum

### 1.8.1
* reordered the thruum skillcapes to be listed/sorted in alphabetical order in the shop and bank
...
* jesters drop the guitar, and the essence required to upgrade the guitar, among other thruum related drops

### 1.7.1
* reduced base drop chance of sheet thruum from 5% to 2%
* significantly reduced the sell value of thruum related items, these were not intended to be an easy way to generate gold

### 1.7.0
* agility obstacle 10 waterfall now also benefits the Thruum skill
* astrology variel constellation now also benefits the Thruum skill
* added compatibility between Tiny Passive Icons mod and the Thruum skill mod for Agility and Astrology
...
* half a and half b can drop while training thruum
* both halves + 10M GP can be used to purchase 1,000 charges of a concert pass
* the concert pass can be equipped in the offhand and while training Thruum you also gain Skill XP for the skills the teacher supports

### 1.5.0
* increased drop rate of sheet thruum from 1% to 5%
* expanded the ability to upgrade mastered shout teachers which boost the Thruum skill itself
...
* fixed Aorpheats Signet Ring not providing +100% GP to Thruum
* fixed Max Skillcape, Cape of Completion, Superior Max Skillcape and Superior Cape of Completion not inheriting Thruum Skillcape modifiers (these capes still DO NOT require any Thruum skill levels, they just inherit the modifiers of the Thruum skillcapes)
...
* added a new item, sheet thruum which is dropped while training Thruum
* added a new item, essence of thruum, which is upgraded from sheet thruum
* added the ability to upgrade mastered shout teachers which unlocks a 5th modifier

### 1.3.0
* added a potion to Herblore which increases GP obtained while training Thruum
* added a summoning tablet for the Thruum skill, the Shout
* added a Thruum Scroll of XP which can be purchased from the Township trader with Planks
* added a Thruum Outfit to the Township category of the shop, it functions the same all other skilling outfits
...
* fixed thruum mastery token granting no experience
...
* superior skill cape now also reduces shout Master cost by 10% and increased gold earned from thruum by 10%
...
<a href="https://www.freepik.com/free-vector/cute-red-panda-playing-guitar-cartoon-vector-icon-illustration-animal-thruum-icon-concept-isolated_31966379.htm">Image by catalyststuff on Freepik</a>

<a href="https://www.freepik.com/free-vector/thruumal-teacher-set_8610228.htm#query=cartoon%20teacher&position=0&from_view=keyword&track=ais">Image by pch.vector on Freepik</a>
...
<a href="https://www.freepik.com/free-vector/aesthetic-jazz-background-thruumal-teacher-border-blue-vector_20346432.htm#query=thruumal%20background&position=16&from_view=search&track=ais">Image by rawpixel.com on Freepik</a>

<a href="https://www.flaticon.com/free-icons/thruum-and-multimedia" title="thruum and multimedia icons">Thruum and multimedia icons created by Mihimihi - Flaticon</a>
